...
func TestLoadSessionTranscriptPreservesOrdinal(t *testing.T) {
	...
	data := `{"type":"event_msg","timestamp":"2026-01-01T00:00:00Z","payload":{"type":"user_message","message":"first"}}
{"type":"event_msg","timestamp":"2026-01-01T00:01:00Z","payload":{"type":"user_message","message":"second"}}
`
